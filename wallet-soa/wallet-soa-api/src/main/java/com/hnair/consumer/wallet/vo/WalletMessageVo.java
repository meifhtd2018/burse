...
public class WalletMessageVo<T> implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7932338542757703093L;
	/**
	...
	public WalletMessageVo(boolean result, String message, T t) {
		this.result = result;
		this.message = message;
		this.t = t;
	}

	public WalletMessageVo(boolean result, String message, String errorCode, String errorMessage, T t) {
		this.result = result;
		this.message = message;
